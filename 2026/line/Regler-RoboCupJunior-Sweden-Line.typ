...
sedan lämna Räddningsplatsen och fortsätta navigera banan.
...
+ De modulära brickorna skall vara 30x30 cm. Brickornas placering, antal och typ
  skall göras tillgänglig på tävlingsdagen, och inte innan. Brickorna kan
  monteras på valfritt hårt underlag.
...
+ Kontrollpunkterna ska vara #reformulation([markerade]) på ett sådant sätt så att det är tydligt
  för deltagare och domare.
...
+ Farthinder får ej vara större än en bricka samt får vara högst 1 cm höga, de
  skall vara av samma färg som underlaget samt vara fastsatta i underlaget.
+ Farthinder får placeras vart som helst inom Räddningsplatsen. Farthinder i
    Räddningsplatsen ger inga poäng.
...
+ Evakueringspunkterna är rätvinkliga trianglar med sidorna 30x30 cm.
  - En av evakueringspunkterna skall vara röd och där skall döda offer placeras
    av roboten.
...
+ Domaren får innan start placera ut evakueringspunkterna i Räddningsplatsens
  hörn, dessa hörn får ej vara där en ingång eller utgång förekommer.
...
+ Verktyg är tillåtna så länge de är utvecklade av laget eller när de inte
  ...
  eller bibliotek som är nödvändiga för sensorers funktion).
...
+ När en robot besöker nästa kontrollpunkt eller stannar på slut brickan får den
  poäng per besökt bricka och antalet försök enligt följande:
