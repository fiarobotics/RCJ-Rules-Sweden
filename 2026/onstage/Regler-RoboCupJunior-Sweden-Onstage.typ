...
7. Föreställningen kan komma att filmas samt livesändas för publik. Filmade föreställningar kan komma att användas för marknadsföring av RoboCup Junior. Lag som inte vill att deras föreställning filmas eller livesändas skall informera tävlingsarrangören om detta.
...
2. Laget kan starta om utan att lämna scenen genom en tydlig nedräkning.
3. Poäng nollställs mellan varje omstart, med undantag av avdrag orsakat av omstarterna.
...
2. Laget får använda sig av en multimedia presentation på sin föreställning. Detta kan vara till exempel en video, animation eller bildspel. Denna skall vara skapat av laget själva.
