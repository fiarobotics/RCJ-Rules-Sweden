...
#grid(
  ...
  [
    #align(
      ...
      text(30pt)[
        Regler \
        RoboCup Junior Rescue Maze 2026
      ],
    )
  ],
  [
...
räddningskit av roboten ger den 10 #new_rule([eller 30]) poäng per #new_rule([offer]). Antalet extra poäng
som roboten får beror på typen av offer.
- #new_rule([30]) poäng för skadade bokstavs offer
- 10 poäng för stabila bokstavs offer
- Inga ytterligare poäng för ett oskadat bokstavs offer
- #new_rule([30]) poäng för #new_rule([en skadad kognitiv måltavla])
...
+ En robot får som mest bära på #new_rule([8]) räddningskit.
...
+ Innan ett poänglopp börjar ska domaren kasta en 6-sidig tärning eller en annan
  ...
  de svarta, blåa, röda och silveriga brickorna. Domaren ska inte avslöja positionen för
  de svarta, blåa, röda och silveriga brickorna för laget förrän de är redo att börja
...
+ 10 poäng ges #new_rule([för lyckad placering av ett räddningskit, 
  ...
  + #new_rule([Kognitiva måltavlor]):
    ...
    + #new_rule([Stabil (1)]): ett räddningskit per offer. (Maximala poäng för räddningskitplacering per
      offer: 10 poäng.)
    + #new_rule([Oskadad (0)]): inga räddningskit per offer.
...
+ Pålitlighetsbonusen är ett icke-negativt tal och består av antalet lyckade
  ...
  $
    ("RELIABILITY BONUS") = ("SVI") times 10 + ("SRD") times 10 #new_rule([(SBV) times 10]) - ("LoP") times #new_rule([15])
  $
